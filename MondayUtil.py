...
if __name__ == "__main__":
    ...
    UpdateSyncToMonday(config,history['2022-06-14'])
    UpdateSavingsChartingBaord(config,'2022-06-14')
    UpdateSyncToMonday(config,history['2022-06-15'])
    UpdateSavingsChartingBaord(config,'2022-06-15')
